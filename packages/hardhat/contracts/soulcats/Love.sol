...
contract Love is ContractMetadata, Multicall, Ownable, ERC20Permit, PrimarySale, SoulCatsDropSinglePhase, IBurnableERC20 {
    ...
    address private _knowledgeAddrress;
    ...
    constructor(
        ...
        address _newCareAddress,
        address _newRespectAddress,
        address _newResponsibilityAddress,
        address _newKnowledgeAddress
    ) ERC20Permit(_name, _symbol) {
        _setupOwner(_defaultAdmin);
        _careAddrress = _newCareAddress;
        _respectAddrress = _newRespectAddress;
        _responsibilityAddrress = _newResponsibilityAddress;
        _knowledgeAddrress = _newKnowledgeAddress;
    ...
    function _collectPriceOnClaim(
        ...
        CurrencyTransferLib.transferCurrency(_currency1, msg.sender, saleRecipient, totalPrice);
        CurrencyTransferLib.transferCurrency(_currency2, msg.sender, saleRecipient, totalPrice);
        CurrencyTransferLib.transferCurrency(_currency3, msg.sender, saleRecipient, totalPrice);
        CurrencyTransferLib.transferCurrency(_currency4, msg.sender, saleRecipient, totalPrice);
    }
