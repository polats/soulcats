...
contract Responsibility is ContractMetadata, Multicall, Ownable, ERC20Permit, PrimarySale, DropSinglePhase, IMintableERC20, IBurnableERC20 {
    address private _soulCatAddress;
    ...
    constructor(
        ...
        address _newSoulCatAddress
    ) ERC20Permit(_name, _symbol) {
        _setupOwner(_defaultAdmin);
        _soulCatAddress = _newSoulCatAddress;
